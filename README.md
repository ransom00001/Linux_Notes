...
* ***mv:*** (move) moves a file or a directory to another file or directory. And also used to rename a file or a directory.

* ***cp:*** (copy) copies a file or directory to another file or directory.
